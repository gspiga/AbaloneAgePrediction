...
# Drop all non-signicant variables

intModel.red <-
  lm(
    log(Rings) ~ Height + Shucked.weight + Shell.weight + Diameter + Infant + Height:Infant + Height:Diameter + Shucked.weight:Diameter + Shucked.weight:Infant + Diameter:Infant,
    data = aba_red
  )
summary(intModel.red)

# Removing non significant variable Diameter:Shucked Weight once more
intModel.red <-
  lm(
...
# BIC suggests we drop interaction between height and infant 
intModel.final <-
  lm(
